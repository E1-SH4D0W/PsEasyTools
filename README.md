...
### BecomeTI
Self-elevating script that opens a new CMD window with the user group NtAuthority\TrustedInstaller enabled. Use to do anything your heart desires! (Within limits of course. EL SHADOW does not condone the use of their scripts for legal/illicit purposes and is not responsible for damage down to systems) DISCLAIMER: Some commands may still throw access-denied errors, due to ACLs or other weirdness. Google it if needed.
